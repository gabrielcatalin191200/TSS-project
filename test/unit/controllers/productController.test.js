...
describe("productController", () => {
    ...
    describe('@createProduct', () => {
        ...
        it('should create a product', async () => {
            const { req, res } = createMockReqRes({ name: 'product1', price: 100, description: 'description' }, {}, { userId: '123' });
    
            const mockProduct = { _id: '123', name: 'product1', price: 100, description: 'description' };
    ...
    describe('@getAllProducts', () => {
        ...
        it('should get all products', async () => {
            ...
            const mockProducts = [{ _id: '123', name: 'product1', price: 100, description: 'description' }];
            ...
            expect(res.json.calledWith({ products: mockProducts, count: mockProducts.length })).to.be.true;
        });
    });
    ...
    describe('@getSingleProduct', () => {
        ...
        beforeEach(() => {
            ...
            findOneStub = sinon.stub(Product, 'findOne').returns({ populate: populateStub });
        });
    ...
    describe('@updateProduct', () => {
        ...
        it('should update a product', async () => {
            const id = '507f1f77bcf86cd799439011';
            const { req, res } = createMockReqRes({ name: 'product1', price: 100, description: 'description' }, { id }, { userId: '123' });
    ...
    describe('@deleteProduct', () => {
        ...
        it('should delete a product', async () => {
            ...
            expect(res.status.calledWith(StatusCodes.OK)).to.be.true;
            expect(res.json.calledWith({ msg: 'Success! Product removed' })).to.be.true;
        });
